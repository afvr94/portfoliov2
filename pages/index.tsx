...
const Home: FC<{ projects: Project[] }> = ({ projects }) => {
  return (
    <Box width="100vw" bg="blackAlpha.700" height="100vh" padding="15px">
      <Sidebar />
          ...
          >
            ...
            <Box marginTop="10px">
              <Text fontSize="lg" fontWeight="normal">
                ...
                University of Puerto Rico in Mayagüez with a degree in Computer
                Engineering. I love to create projects that make an impact on
                society. I&apos;m interested in the whole frontend stack like
                React + Redux, etc. To build unique projects and bring designs
                to life. Also, I&apos;m interested in the Python + NodeJS stacks
                for the backend. I&apos;m a fitness freak, and I like to
                weightlift and do cycling. I love to explore and learn new
